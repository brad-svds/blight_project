---
title: "Blight Final Report"
author: "Brad Allen"
date: "July 16, 2016"
output: pdf_document
---

_Submit a brief report describing your features, your method, and the accuracy of the model. If your method is effective, provide sufficient detail to convince the reviewer of this. Be detailed and specific!_
...
We were asked to, based on commonly accepted predictors of blight, develop a model to determine which individual homes would become blighted / up for demolition. The datasets provided can be found at the [Detroit Open Data Portal](https://data.detroitmi.gov/) and the [course Github repo](https://github.com/uwescience/datasci_course_materials).

After transforming and preparing the data for analysis, my model (random forest) was able to accurately predict the blighted properties 75.7% of the time with a Kappa statistic of 0.5149, which Landis and Koch would describe as [providing "moderate agreement."](https://en.wikipedia.org/wiki/Fleiss%27_kappa)

All of my work can be found and used for reproduction [in my Github repo at this link](https://github.com/brad-svds/blight_project). 
...
As mentioned in the Executive Summary, my model (random forest) was able to accurately predict the blighted properties 75.7% of the time with a Kappa statistic of 0.5149, which Landis and Koch would describe as [providing "moderate agreement."](https://en.wikipedia.org/wiki/Fleiss%27_kappa) 
